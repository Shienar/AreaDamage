table = {
	...
	[220098] = true,			-- Grave Lord's Sacrifice ("Buffed 3rd skull hit) | Last Checked:  base morph."
	...
	-- CATEGORY: Skill>Class>Sorcerer>Daedric Summoing
	[24329] = true,			-- Daedric Prey | Last Checked: U47

	-- CATEGORY: Skill>Class>Sorcerer>Daedric Summoming
